---
name: agent-mobile
description: Mobile app E2E testing CLI for AI agents with semantic locators and element references
user-invocable: true
...
- **Implementation Guide**: `/Users/r0227n/Dev/agent-mobile/AGENTS.md`
