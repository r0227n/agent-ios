...
echo "  1. Prepare simulator or device:"
...
echo "  1. Prepare emulator or device:"
echo "     $ adb devices"
echo "     $ agent-mobile device list"
echo ""
echo "  2. Run command:"
...
echo "3. Real device ✓   → direct agent-mobile verification on simulator/emulator/device (REQUIRED!)"
echo ""
