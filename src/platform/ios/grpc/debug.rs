...
use crate::platform::ios::proto::idb::log_request::Source as LogSource;
use crate::platform::ios::proto::idb::LogRequest;
...
impl IdbClient {
    ...
    pub async fn log(
        ...
        tonic::Streaming<crate::platform::ios::proto::idb::LogResponse>,
    ...
    pub async fn crash_list(
        ...
        Vec<crate::platform::ios::proto::idb::CrashLogInfo>,
        Box<dyn std::error::Error + Send + Sync>,
    > {
        let query = crate::platform::ios::proto::idb::CrashLogQuery {
    ...
    pub async fn crash_show(
        ...
        crate::platform::ios::proto::idb::CrashShowResponse,
        Box<dyn std::error::Error + Send + Sync>,
    > {
        let request = tonic::Request::new(crate::platform::ios::proto::idb::CrashShowRequest {
            name: name.to_string(),
        });
    ...
    pub async fn debugserver_start(
        ...
        use crate::platform::ios::proto::idb::debug_server_request::{Control, Start};
        use crate::platform::ios::proto::idb::DebugServerRequest;
        ...
        if let Some(resp) = stream.message().await? {
            if let Some(crate::platform::ios::proto::idb::debug_server_response::Control::Status(
                status,
            )) = resp.control
            {
    ...
    pub async fn debugserver_stop(
        ...
        use crate::platform::ios::proto::idb::debug_server_request::{Control, Stop};
        use crate::platform::ios::proto::idb::DebugServerRequest;
    ...
    pub async fn debugserver_status(
        ...
        use crate::platform::ios::proto::idb::debug_server_request::{Control, Status};
        use crate::platform::ios::proto::idb::DebugServerRequest;
    ...
    pub async fn dap(
        ...
        use crate::platform::ios::proto::idb::dap_request::{Control, Pipe, Start, Stop};
        use crate::platform::ios::proto::idb::DapRequest;
        ...
        if let Some(resp) = stream.message().await? {
            if resp.output.is_none()
                || !matches!(
                    resp.output,
                    Some(crate::platform::ios::proto::idb::dap_response::Output::Started(_))
                )
            {
            ...
            tokio::select! {
                ...
                response = stream.message() => {
                    match response? {
                        Some(resp) => {
                            match resp.output {
                                Some(crate::platform::ios::proto::idb::dap_response::Output::Stdout(pipe)) => {
                                    stdout.write_all(&pipe.data).await?;
                                    stdout.flush().await?;
                                }
                                Some(crate::platform::ios::proto::idb::dap_response::Output::Stopped(_)) => {
    ...
    pub async fn instruments_run(
        ...
        use crate::platform::ios::proto::idb::instruments_run_request::{
            self, Control, Start, Stop,
        };
        use crate::platform::ios::proto::idb::instruments_run_response::Output;
        use crate::platform::ios::proto::idb::InstrumentsRunRequest;
                        ...
                        Some(response) => {
                            match response.output {
                                Some(Output::State(state)) => {
                                    use crate::platform::ios::proto::idb::instruments_run_response::State;
    ...
    pub async fn xctrace_record(
        ...
        use crate::platform::ios::proto::idb::xctrace_record_request::{
            self, Control, Start, Stop, Target,
        };
        use crate::platform::ios::proto::idb::xctrace_record_response::Output;
        use crate::platform::ios::proto::idb::XctraceRecordRequest;
                ...
                msg = stream.message() => {
                    match msg? {
                        Some(response) => {
                            match response.output {
                                Some(Output::State(state)) => {
                                    use crate::platform::ios::proto::idb::xctrace_record_response::State;
                                    match State::try_from(state) {
                                        Ok(State::Running) => {
                                            received_running = true;
