...
use crate::platform::ios::proto::idb::push_request;
use crate::platform::ios::proto::idb::tail_request::{self, Control as TailControl};
use crate::platform::ios::proto::idb::{Payload, PullRequest, PushRequest, RmRequest, TailRequest};
...
impl IdbClient {
    ...
    pub async fn ls(
        ...
        path: String,
        paths: Vec<String>,
        container: Option<crate::platform::ios::proto::idb::FileContainer>,
    ) -> Result<
        crate::platform::ios::proto::idb::LsResponse,
        Box<dyn std::error::Error + Send + Sync>,
    > {
        let request = tonic::Request::new(crate::platform::ios::proto::idb::LsRequest {
            path,
            container,
            paths,
        });
    ...
    pub async fn mkdir(
        &mut self,
        path: &str,
        container: crate::platform::ios::proto::idb::FileContainer,
    ) -> Result<(), Box<dyn std::error::Error + Send + Sync>> {
        let request = tonic::Request::new(crate::platform::ios::proto::idb::MkdirRequest {
            path: path.to_string(),
    ...
    pub async fn mv(
        ...
        let request = tonic::Request::new(crate::platform::ios::proto::idb::MvRequest {
            src_paths,
    ...
    pub async fn pull(
        ...
        tonic::Streaming<crate::platform::ios::proto::idb::PullResponse>,
        Box<dyn std::error::Error + Send + Sync>,
    > {
