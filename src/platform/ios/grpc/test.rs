...
use crate::platform::ios::proto::idb::xctest_run_request::{self, Mode};
use crate::platform::ios::proto::idb::{
    InstallRequest, InstallResponse, Payload, XctestRunRequest,
};
...
impl IdbClient {
    ...
    pub async fn xctest_list_bundles(
        ...
        Vec<crate::platform::ios::proto::idb::xctest_list_bundles_response::Bundles>,
        Box<dyn std::error::Error + Send + Sync>,
    > {
        let request =
            tonic::Request::new(crate::platform::ios::proto::idb::XctestListBundlesRequest {});
    ...
    pub async fn xctest_list_tests(
        ...
        let request =
            tonic::Request::new(crate::platform::ios::proto::idb::XctestListTestsRequest {
                bundle_name,
    ...
    pub async fn xctest_run_logic(
        ...
        tonic::Streaming<crate::platform::ios::proto::idb::XctestRunResponse>,
        Box<dyn std::error::Error + Send + Sync>,
    > {
