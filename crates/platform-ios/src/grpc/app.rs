...
use crate::proto::idb::launch_request::{self, Control};
use crate::proto::idb::payload::Source as PayloadSource;
use crate::proto::idb::process_output::Interface;
use crate::proto::idb::{InstallRequest, InstallResponse, LaunchRequest, Payload};
...
impl IdbClient {
    ...
    pub async fn uninstall(
        ...
        let request = tonic::Request::new(crate::proto::idb::UninstallRequest {
    ...
    pub async fn list_apps(
        &mut self,
    ) -> Result<Vec<crate::proto::idb::InstalledAppInfo>, Box<dyn std::error::Error + Send + Sync>>
    {
        let request = tonic::Request::new(crate::proto::idb::ListAppsRequest {
    ...
    pub async fn terminate(
        ...
        let request = tonic::Request::new(crate::proto::idb::TerminateRequest {
            bundle_id: bundle_id.to_string(),
        });
