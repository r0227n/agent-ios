...
use crate::proto::idb::{InstallRequest, InstallResponse, Payload};
...
impl IdbClient {
    ...
    pub async fn contacts_update(
        ...
        let request = tonic::Request::new(crate::proto::idb::ContactsUpdateRequest {
    ...
    pub async fn contacts_clear(&mut self) -> Result<(), Box<dyn std::error::Error + Send + Sync>> {
        let request = tonic::Request::new(crate::proto::idb::ContactsClearRequest {});
    ...
    pub async fn clear_keychain(&mut self) -> Result<(), Box<dyn std::error::Error + Send + Sync>> {
        let request = tonic::Request::new(crate::proto::idb::ClearKeychainRequest {});
    ...
    pub async fn simulate_memory_warning(
        ...
        let request = tonic::Request::new(crate::proto::idb::SimulateMemoryWarningRequest {});
    ...
    pub async fn focus(&mut self) -> Result<(), Box<dyn std::error::Error + Send + Sync>> {
        let request = tonic::Request::new(crate::proto::idb::FocusRequest {});
    ...
    pub async fn approve(
        ...
        let request = tonic::Request::new(crate::proto::idb::ApproveRequest {
    ...
    pub async fn revoke(
        ...
        let request = tonic::Request::new(crate::proto::idb::RevokeRequest {
            bundle_id: bundle_id.to_string(),
            permissions,
            scheme: scheme.unwrap_or_default(),
        });
    ...
    pub async fn send_notification(
        ...
        let request = tonic::Request::new(crate::proto::idb::SendNotificationRequest {
            bundle_id: bundle_id.to_string(),
    ...
    pub async fn set_location(
        ...
        let request = tonic::Request::new(crate::proto::idb::SetLocationRequest {
            location: Some(crate::proto::idb::Location {
                latitude,
                longitude,
            }),
        });
    ...
    pub async fn open_url(
        ...
        let request = tonic::Request::new(crate::proto::idb::OpenUrlRequest {
            url: url.to_string(),
        });
    ...
    pub async fn set_setting(
        &mut self,
        setting: crate::proto::idb::setting_request::Setting,
    ) -> Result<(), Box<dyn std::error::Error + Send + Sync>> {
        use crate::proto::idb::SettingRequest;
    ...
    pub async fn get_setting(
        &mut self,
        setting: crate::proto::idb::Setting,
        name: Option<String>,
        domain: Option<String>,
    ) -> Result<String, Box<dyn std::error::Error + Send + Sync>> {
        use crate::proto::idb::GetSettingRequest;
    ...
    pub async fn list_settings(
        ...
        use crate::proto::idb::ListSettingRequest;
